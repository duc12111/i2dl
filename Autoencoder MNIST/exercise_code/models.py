...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20):
        ...
        self.encoder = nn.Sequential(
          nn.Linear(self.input_size, self.hparams["n_hidden"][0]),
          nn.BatchNorm1d(self.hparams["n_hidden"][0]),
          nn.ReLU(True),      
          nn.Linear(self.hparams["n_hidden"][0], self.hparams["n_hidden"][1]),
          nn.BatchNorm1d(self.hparams["n_hidden"][1]),
          nn.ReLU(True),      
          nn.Linear(self.hparams["n_hidden"][1], self.hparams["n_hidden"][2]),
          nn.ReLU(True), 
          nn.Linear(self.hparams["n_hidden"][2], self.hparams["n_hidden"][3]),
          nn.ReLU(True), 
          nn.Linear(self.hparams["n_hidden"][3], self.hparams["n_hidden"][4]),
          nn.ReLU(True),
          nn.Linear(self.hparams["n_hidden"][4], latent_dim),
        )
...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=20, output_size=28 * 28):
        ...
        self.decoder = nn.Sequential(
          nn.Linear(latent_dim, self.hparams["n_hidden"][4]),
          nn.ReLU(),    
          nn.Linear(self.hparams["n_hidden"][4], self.hparams["n_hidden"][3]),
          nn.ReLU(),  
          nn.Linear(self.hparams["n_hidden"][3], self.hparams["n_hidden"][2]),
          nn.ReLU(),      
...
class Autoencoder(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optim = torch.optim.Adam(self.parameters(),lr=0.000001)
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        self.model = nn.Sequential (
          ...
          nn.ReLU(),              
          nn.Linear(self.encoder.latent_dim, 10)
        )
